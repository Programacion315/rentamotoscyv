...
export default function RentalDetails() {
  ...
  // Find the selected motorcycle or default to NMAX if not found
  const moto = useMemo(() => {
  ...
  // Construct WhatsApp confirmation message link
  const whatsappLink = useMemo(() => {
    const { days, total, deliveryFee, insuranceFee } = bookingSummary;
    if (days === 0) return "#";
      ...
      <main className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg min-h-screen">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            {/* Spec Sheet (Using custom Smoothie/Smooch Sans typography for spec headings) */}
          ...
          {/* Right Column: Pricing Calculator Widget */}
